! function (e, t) {
  ...
  return function (e) {
    ...
    e.exports = ((e, t = "get", o = {}) => new Promise((s, i) => {
      ...
      void 0 === r.User && (r = n(0));
      var c = r.User.current();
      c && (a["X-Bmob-Session-Token"] = c.sessionToken), "object" == typeof o && (o = JSON.stringify(o)), "xxrequire('@system.fetch')xx".fetch({
        url: r._config.host + e,
        header: a,
        method: t,
        data: o,
    ...
    e.exports = class extends s {
      ...
      decryption(e) {
        ...
        return new Promise((n, o) => {
          const s = e.iv ? e.iv : e.detail.iv,
            a = e.encryptedData ? e.encryptedData : e.detail.encryptedData,
            c = {
              sessionKey: t.current().authData.weapp.session_key,
              encryptedData: a,
              iv: s
            },
